...
_file_training_set_label = open("training_set_labels.txt", "r")
label_lines = [line.rstrip() for line in _file_training_set_label]
		...
		if time_counter % 45 == 0 and realTime:
			...
			# Say the letter out loud
				...
				if len(current_word) > 0:
					if spell_check:
						speak_letter(spell_checker.correction(current_word)) # remove
					else:
